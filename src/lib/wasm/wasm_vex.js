...
* @returns {any}
*/
export function parse_vep_header(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.parse_vep_header(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function verify_pillar_hashes(intent_hash, authority_hash, identity_hash, witness_hash, expected_root) {
    const ptr0 = passStringToWasm0(intent_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(authority_hash, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_vex_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
